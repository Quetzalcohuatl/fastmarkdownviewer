...
> **Alpha:** v0.1.0-alpha.3 exercises the core Windows workflow. Performance numbers will be published only after the reproducible Windows launch suite has run.
