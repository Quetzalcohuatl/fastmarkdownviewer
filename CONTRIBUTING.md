...
Please open an issue before adding user-facing scope. The current scope includes read-only tabs, find, an outline, lazy syntax highlighting, offline Mermaid, and saved preferences/sessions on Windows, macOS, and Ubuntu. Editing, export, annotations, file watching, browsing history, and automatic updates remain outside this scope. Fixes, accessibility improvements, compatibility work, tests, and measured performance improvements are welcome.
